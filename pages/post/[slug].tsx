    ...
    <main>
      ...
      {submitted ? (
        ...
        <form
          ...
          className="mx-auto mb-10 flex flex-col p-5"
        >
          ...
          <label className="mb-5 block">
            ...
            <textarea
              ...
              className="form-textarea focus:ring-0.5 mt-1 block w-full rounded border py-2 px-3 shadow outline-none ring-yellow-500 focus:ring"
